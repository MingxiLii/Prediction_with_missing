...
from selfAttentionImpute.layers import *
from selfAttentionImpute.utils import masked_mae_cal
    ...
    def forward(self, inputs, stage):
        ...
        if stage != "test":
            ...
            imputation_MAE = masked_mae_cal(
                imputed_data, inputs["X_holdouts"], inputs["indicating_mask"]
            )
            # print(imputation_MAE)
        else:
