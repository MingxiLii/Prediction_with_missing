import numpy as np
from attnGN import selfAttenGN, load_metr_LA,load_PEMSD8,load_seattle,load_PEMS,ablation_3
import torch
...
parser.add_argument('--use_model', type=str, default="ablation_3")
...
model = ablation_3(input_channels=1, hidden_channels=1, hidden_channels_2=1, node_attr_size=12, out_size=args.pre_len,  device=device, edge_hidden_size=1 , node_hidden_size=12 ,
